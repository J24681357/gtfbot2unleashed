...
module.exports = {
 ...
 "When the success prompt appears after you select a lobby, the GTF bot will ping you inside the thread (this is where the joined lobby is located." + "\n" +
    ...
    "4. You may also mark a car as your favorite with the ⭐ to select it in the favorites options in the drop down menu in different places."  + "\n" + 
     ...
     "__**Items - /items**__" + "\n" +  
     "1. In this GTF game, you can earn rewards that can be redeemable in **/items**." + "\n" +
     "2. This command will open the list of items that you have earned. Selecting one of them will redeem the item to your save data accordingly." + "\n" +
     "3. You can quickly redeem your latest item by using **/items - Redeem Latest Reward**"
    ]
